...
var dealsUpdateDealByIdCmd = &cobra.Command{
	Use:   "update-deal-by-id",
	Short: "Update a deal",
	RunE:  runDealsUpdateDealById,
}
...
func runDealsUpdateDealById(cmd *cobra.Command, args []string) error {
	...
	pathParams["id"] = fmt.Sprintf("%v", dealsUpdateDealByIdFlags.id)
	...
	if dealsUpdateDealByIdFlags.body != "" {
		if err := json.Unmarshal([]byte(dealsUpdateDealByIdFlags.body), &bodyMap); err != nil {
