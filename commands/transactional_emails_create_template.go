...
func init() {
	transactionalEmailsCreateTemplateCmd.Flags().StringVar(&transactionalEmailsCreateTemplateFlags.body, "body", "", "Full request body as JSON (overrides individual flags)")
