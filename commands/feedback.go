...
const (
	...
	feedbackToken    = "3d57a83c-993a-4ece-aa6c-ac1f07ddea19"
)
...
Examples:
  brevo-api feedback "the --filter regex syntax is unclear"
  brevo-api feedback --about "create-widget" "exit code 0 but no output"
`,
