...
var dealsCreateNewDealCmd = &cobra.Command{
	Use:   "create-new-deal",
	Short: "Create a deal",
	RunE:  runDealsCreateNewDeal,
}
...
func runDealsCreateNewDeal(cmd *cobra.Command, args []string) error {
	...
	if dealsCreateNewDealFlags.body != "" {
		if err := json.Unmarshal([]byte(dealsCreateNewDealFlags.body), &bodyMap); err != nil {
