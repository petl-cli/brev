...
var ecommerceManageOrderStatusCmd = &cobra.Command{
	Use:   "manage-order-status",
	Short: "Managing the status of the order",
	RunE:  runEcommerceManageOrderStatus,
}
...
func runEcommerceManageOrderStatus(cmd *cobra.Command, args []string) error {
	...
	req := &httpclient.Request{
		Method:      "POST",
		Path:        httpclient.SubstitutePath("/orders/status", pathParams),
	...
	if ecommerceManageOrderStatusFlags.body != "" {
		if err := json.Unmarshal([]byte(ecommerceManageOrderStatusFlags.body), &bodyMap); err != nil {
