...
var webhooksCreateHookCmd = &cobra.Command{
	Use:   "create-hook",
	Short: "Create a webhook",
	RunE:  runWebhooksCreateHook,
}
...
func runWebhooksCreateHook(cmd *cobra.Command, args []string) error {
	...
	if webhooksCreateHookFlags.body != "" {
		if err := json.Unmarshal([]byte(webhooksCreateHookFlags.body), &bodyMap); err != nil {
