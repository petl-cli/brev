...
func init() {
	transactionalEmailsSendTransactionalEmailCmd.Flags().StringVar(&transactionalEmailsSendTransactionalEmailFlags.body, "body", "", "Full request body as JSON (overrides individual flags)")
