...
var contactsCreateListCmd = &cobra.Command{
	Use:   "create-list",
	Short: "Create a list",
	RunE:  runContactsCreateList,
}

var contactsCreateListFlags struct {
	name     string
	folderId int
	body     string
}
...
func runContactsCreateList(cmd *cobra.Command, args []string) error {
	...
	if contactsCreateListFlags.body != "" {
		if err := json.Unmarshal([]byte(contactsCreateListFlags.body), &bodyMap); err != nil {
	...
	if cmd.Flags().Changed("name") {
		bodyMap["name"] = contactsCreateListFlags.name
	}
	if cmd.Flags().Changed("folder-id") {
		bodyMap["folderId"] = contactsCreateListFlags.folderId
	}
	req.Body = bodyMap
