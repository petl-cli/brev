...
var couponsUpdateCouponCollectionByIdCmd = &cobra.Command{
	Use:   "update-coupon-collection-by-id",
	Short: "Update a coupon collection by id",
	RunE:  runCouponsUpdateCouponCollectionById,
}

var couponsUpdateCouponCollectionByIdFlags struct {
	id                    string
...
func runCouponsUpdateCouponCollectionById(cmd *cobra.Command, args []string) error {
	...
	if rootFlags.schema {
		...
		schema := map[string]any{
			"command":     "update-coupon-collection-by-id",
	...
	pathParams["id"] = fmt.Sprintf("%v", couponsUpdateCouponCollectionByIdFlags.id)
	...
	if couponsUpdateCouponCollectionByIdFlags.body != "" {
		if err := json.Unmarshal([]byte(couponsUpdateCouponCollectionByIdFlags.body), &bodyMap); err != nil {
	...
	if cmd.Flags().Changed("default-coupon") {
		bodyMap["defaultCoupon"] = couponsUpdateCouponCollectionByIdFlags.defaultCoupon
	}
	if cmd.Flags().Changed("expiration-date") {
		bodyMap["expirationDate"] = couponsUpdateCouponCollectionByIdFlags.expirationDate
	}
	if cmd.Flags().Changed("remaining-days-alert") {
		bodyMap["remainingDaysAlert"] = couponsUpdateCouponCollectionByIdFlags.remainingDaysAlert
	}
	if cmd.Flags().Changed("remaining-coupons-alert") {
		bodyMap["remainingCouponsAlert"] = couponsUpdateCouponCollectionByIdFlags.remainingCouponsAlert
	}
	req.Body = bodyMap
